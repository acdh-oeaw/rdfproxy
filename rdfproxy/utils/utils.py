...
from rdfproxy.utils.type_utils import _is_scalar_type
...
class OrderByFieldBindingsMap(FieldsBindingsMap):
    """Recursive FieldBindingsMap that generates namespaced key entries for orderable fields."""
